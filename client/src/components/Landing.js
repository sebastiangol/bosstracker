    ...
    <div className="w-screen relative flex items-center justify-center">
      ...
      <div className="absolute text-center text-5xl text-black font-bold flex flex-col justify-between top-64">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="cursor-pointer flex items-center justify-center p-2 text-amber-400 border-2 border-amber-400 rounded-md shadow-lg bg-teal-800 w-fit hover:scale-105 active:scale-95 transition-transform duration-200 ease-out">
            Create one!
          </div>
        </div>
      </div>
